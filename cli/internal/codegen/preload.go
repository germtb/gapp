...
// It imports gap's RouteSpec/RpcSpec types directly so the generated var
// is compatible with gap.NewPreloadEngine.
func GeneratePreloadGo(routes []RoutePreload, packageName string) string {
	...
	b.WriteString("// Code generated by gap codegen. DO NOT EDIT.\n\n")
	...
	b.WriteString("var RoutePreloads = []gap.RouteSpec{\n")
	...
	for _, route := range routes {
		...
		b.WriteString("\t\tRpcs: []gap.RpcSpec{\n")
